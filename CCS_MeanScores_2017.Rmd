...
# 7) avg_organisational_coord col= 34:37
# 8) avg_community_centred_care, col= 16:19
# 9) avg_healthcare_policy, col= 38:40
# 10) avg_technical_competence, col= 41:50
...
for(c in 1:length(un_countries))
{
  ...
  df_countries[c,4] <- mean(data.matrix(c_data[,11:15]), na.rm=T) #avg_person_centered_care
  df_countries[c,5] <- mean(data.matrix(c_data[,20:26]), na.rm=T) # avg_service_coord
  df_countries[c,6] <- mean(data.matrix(c_data[,27:33]), na.rm=T) # avg_professional_coord
  df_countries[c,7] <- mean(data.matrix(c_data[,34:37]), na.rm=T) # avg_organisational_coord
  df_countries[c,8] <- mean(data.matrix(c_data[,16:19]), na.rm=T) # avg_community_centred_care
  df_countries[c,9] <- mean(data.matrix(c_data[,38:40]), na.rm=T) # avg_healthcare_policy
  df_countries[c,10] <- mean(data.matrix(c_data[,41:50]), na.rm=T) # avg_technical_competence
  df_countries[c,11] <- mean(data.matrix(c_data[,51:58]), na.rm=T) # avg_cultural_competence
...
df_countries[22,4] <- mean(data.matrix(ccs_hist[,11:15]), na.rm=T) #avg_person_centered_care
df_countries[22,5] <- mean(data.matrix(ccs_hist[,20:26]), na.rm=T) # avg_service_coord
df_countries[22,6] <- mean(data.matrix(ccs_hist[,27:33]), na.rm=T) # avg_professional_coord
df_countries[22,7] <- mean(data.matrix(ccs_hist[,34:37]), na.rm=T) # avg_organisational_coord
df_countries[22,8] <- mean(data.matrix(ccs_hist[,16:19]), na.rm=T) # avg_community_centred_care
df_countries[22,9] <- mean(data.matrix(ccs_hist[,38:40]), na.rm=T) # avg_healthcare_policy
df_countries[22,10] <- mean(data.matrix(ccs_hist[,41:50]), na.rm=T) # avg_technical_competence
df_countries[22,11] <- mean(data.matrix(ccs_hist[,51:58]), na.rm=T) # avg_cultural_competence
...
write.csv(df_countries, file = "data/CCS_meanQuestionare_per_country.csv" , row.names=F )
...
for(cl in 1:length(un_clinics))
{
  ...
  df_clinics[cl,6] <- mean(data.matrix(cl_data[,11:15]), na.rm=T) #avg_person_centered_care
  df_clinics[cl,7] <- mean(data.matrix(cl_data[,20:26]), na.rm=T) # avg_service_coord
  df_clinics[cl,8] <- mean(data.matrix(cl_data[,27:33]), na.rm=T) # avg_professional_coord
  df_clinics[cl,9] <- mean(data.matrix(cl_data[,34:37]), na.rm=T) # avg_organisational_coord
  df_clinics[cl,10] <- mean(data.matrix(cl_data[,16:19]), na.rm=T) # avg_community_centred_care
  df_clinics[cl,11] <- mean(data.matrix(cl_data[,38:40]), na.rm=T) # avg_healthcare_policy
  df_clinics[cl,12] <- mean(data.matrix(cl_data[,41:50]), na.rm=T) # avg_technical_competence
  df_clinics[cl,13] <- mean(data.matrix(cl_data[,51:58]), na.rm=T) # avg_cultural_competence
...
write.csv(df_clinics, file = "data/CCS_meanQuestionare_per_clinic.csv" , row.names=F )
```